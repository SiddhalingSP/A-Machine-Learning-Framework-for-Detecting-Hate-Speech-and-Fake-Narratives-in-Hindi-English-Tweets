...
train_task_a = pd.read_excel("C:\Fake-hate\A-Machine-Learning-Framework-for-Detecting-Hate-Speech-and-Fake-Narratives-in-Hindi-English-Tweets\Train_Task_A.xlsx")
val_task_a = pd.read_excel("C:\Fake-hate\A-Machine-Learning-Framework-for-Detecting-Hate-Speech-and-Fake-Narratives-in-Hindi-English-Tweets\Val_Task_A.xlsx")
test_task_a = pd.read_excel("C:\Fake-hate\A-Machine-Learning-Framework-for-Detecting-Hate-Speech-and-Fake-Narratives-in-Hindi-English-Tweets\Test_Task_A.xlsx")
